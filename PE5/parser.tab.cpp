...
#line 43 "parser.y"
        ...
        cout << "\n\n";
        freeAST((yyvsp[-1].node)); // Clean up memory
    }
...
#line 58 "parser.y"
                           {
        (yyval.node) = new ASTNode("=", new ASTNode((yyvsp[-2].str)), (yyvsp[0].node));
    }
...
#line 76 "parser.y"
               { (yyval.node) = new ASTNode((yyvsp[0].str)); }
